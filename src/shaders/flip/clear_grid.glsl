...
layout(binding = 8, r32f) uniform image3D  gPressureA;
layout(binding = 9, r32f) uniform image3D  gPressureB;
...
void main() {
    ...
    imageStore(gPressureA, c, vec4(0.0));
    imageStore(gPressureB, c, vec4(0.0));
